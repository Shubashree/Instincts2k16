...
$(document).ready(function($){
	...
	/*$('#contactForm').on('submit', function(e){
		...
		var $this = $(this),
			data = $(this).serialize(),
			name = $this.find('#name2'),
			email = $this.find('#email2'),
	...
	if ( $(mapWrapperID).length > 0 && window.google && window.google.maps ) {
		...
		window.mapOps = {
			lat : 12.7485247,	// Provide your latitude
			lng : 80.20273980000002, // Provide your longitude
			content: '<p>SSN College of  Engineering, Old Mahabalipuram Road, Kalavakkam, Tamil Nadu 603110</p>', // Provide your address to show on pop up

                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-center ">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-black btn-default btn-submit" type="submit" formaction="../registration.php">BACK</button>
                            </div> 
                        </div>
                    </div>

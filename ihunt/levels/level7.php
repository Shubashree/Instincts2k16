...
?>
<?php
//if($_SESSION["valid_user"]=='abdul azhar'){
//	echo '<script language="javascript">';
//echo 'alert("Hey azar!! Answer almost nerungita!! adhu oru date dhan. ")';
//echo '</script>';
...
<div class="body-wrap" id="world">
	...
	<img src="qns/lvl7/7.1.jpg" width="150" height="auto"/>&nbsp;&nbsp;&nbsp;&nbsp;
		<img src="qns/lvl7/7.2.jpg" width="150" height="auto"/>
        <img src="qns/lvl7/7.3.jpg" width="150" height="auto"/>
		</center>
		</div><br/>

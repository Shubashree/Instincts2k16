...
<div class="body-wrap" id="world">
	...
	<img src="qns/lvl16/16.1.jpg" width="150" height="auto"/>
	<img src="qns/lvl16/16.2.jpg" width="150" height="auto"/>
	<img src="qns/lvl16/16.3.jpg" width="150" height="auto"/>
	...
	<div class="controls">
	 <div class="input-prepend">
	  ...
	  <input type="submit" class="btn btn-primary" value="Submit" />
         ...
         <div class="footer">
    <p style="bottom:-10px; left:42%;position:absolute; color:#000;">&copy; NaaMDesigns 2016</p>

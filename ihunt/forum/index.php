...
<script src="../js/lib/stats.js"></script>
		...
		<?php } ?>
		<center>
		<h2 style="color:#000">Forums</h2>
		</center>
        <div style="height:270px; width:250px;overflow:auto;margin:0em auto;">
		<table width = "90%" align = "center" border="1" >
		<?php
		for($i=1;$i<=($_SESSION["level"]>20?20:$_SESSION["level"]);$i++)
		{
		?>
		<tr align="center"><td><a href="forum.php?lvl=<?php echo $i; ?>"><span class="yellow" style="font-weight:bold">level <?php echo $i; ?></span></a></td></tr>
		<?php
		}
		?>
		</table>

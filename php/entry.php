<html>
    <head>
        ...
        <title>Instincts Regsistration</title>
        <meta name="description" content="Instincts Regsistration">
    ...
    <body>
      ...
      <div class="col-sm-12 contact-form-start">
            <div class="section-common-space" style="padding-right: 70px">
                <center>
                <form id="contactForm" method="post" class="matx-form-valid contact-form" style="border:1px solid black;border-radius:5px;padding:10px;text-align:center;">
...
<?php
    ...
    if($stmt->execute() === FALSE)
    {
       ...
       { echo " Registration successful. Your INSTINCTS id is : ".$strid."";
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-center ">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-black btn-default btn-submit" type="submit" formaction="../index.php">HOME</button>
                            </div>
                        </div>
                    </div>

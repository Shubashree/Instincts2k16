...
if(isset($_GET['Submit'])){
	...
	if(empty($_SESSION['captcha_code'] ) || strcasecmp($_SESSION['captcha_code'], $_GET['captcha_code']) != 0){  
        ...
        header("Location: php/register2.php?".$_SERVER['QUERY_STRING']);
	}
}	
?>
            ...
            <div class="section-common-space">
                ...
                <form id="contactForm" method="get" class="matx-form-valid contact-form">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-left ">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-black btn-default btn-submit" type="submit" onclick="return checkAll()">SUBMIT</button>
                            </div>
                        </div>
                    </div>

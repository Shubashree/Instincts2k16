...
<!--[if gt IE 8]><!--> <html class="matx no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <meta name="description" content="Instinctsv11">
    ...
    <body>
        ...
        <div class="col-sm-6 contact-form-start">
            <div class="section-common-space">
                ...
                <form id="contactForm" action="php/entry_local.php" method="get" class="matx-form-valid contact-form">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="contactName" id="name" onblur="checkName()" />
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="contactEmail" id="email" onblur="checkEmail()" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="contactCollege" id="college" onblur="checkCollege()"/>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="contactPhone" id="phone" onblur="checkPhone()" />
                        ...
                        <div class="col-sm-12">
                            <div class="text-left ">
                               <!-- <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-black btn-default btn-submit" type="submit" onclick="return checkAll()" name="Submit">SUBMIT</button> -->
                                <input name="Submit" type="submit" value="Submit" onclick="return checkAll();" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-black btn-default btn-submit">

<html>
    <head>
        ...
        <title>Instincts V11</title>
        <meta name="description" content="Instincts V11">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-center ">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-black btn-default btn-submit" type="submit" formaction="../registration_local.php">BACK</button>
                            </div> 
                        </div>
                    </div>
